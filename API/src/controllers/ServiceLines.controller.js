...
controllers.deleteServiceLineById = async (req, res) => {
    try {
        ...
        await notificarEstado(resultado.nome_service_line, "Service Line", false);
...
controllers.updateServiceLineById = async (req, res) => {
    try {
        ...
        if (estado_a_i !== undefined && estado_a_i !== serviceLine.estado_a_i) {
            await notificarEstado(serviceLine.nome_service_line, "Service Line", estado_a_i);
        }
