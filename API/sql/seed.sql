...
-- ============================================================
INSERT INTO Utilizadores (nome_utilizador, email_utilizador, password_utilizador, username_utilizador, tipo_utilizador, imagem_utilizador, estado_a_i) VALUES
('Admin Softinsa',    'admin@softinsa.pt',    '$2b$10$q7grLZi3EFDNK7Bvf2PfneKAmguswEADXPe8IhJOpYNzUwIjtpWca',  'admin',    'AD', 'img-admin', TRUE),
('Talent Manager A',  'tm@softinsa.pt',       '$2b$10$FDHqgkwHpCZ9qeZ2k5jI9.04EC.IJC/p7hJiNRwMG7swcs1R.U98S',  'tm',       'TM', 'img-tm',    TRUE),
('Service Line Leader','sl@softinsa.pt',      '$2b$10$FDHqgkwHpCZ9qeZ2k5jI9.04EC.IJC/p7hJiNRwMG7swcs1R.U98S',  'sl',       'SL', 'img-sl',    TRUE),
('João Consultor',    'consultor1@softinsa.pt','$2b$10$aPmmoiRP5J6giFUDeOEsgec2ZTotulMnpuBxkFUXBH0FyYrXWQaR.', 'joao.co',  'CO', 'img-joao',  TRUE),
('Maria Consultora',  'consultor2@softinsa.pt','$2b$10$aPmmoiRP5J6giFUDeOEsgec2ZTotulMnpuBxkFUXBH0FyYrXWQaR.', 'maria.co', 'CO', 'img-maria', TRUE);
...
-- 5. Consultores
-- ============================================================
INSERT INTO Consultores (id_utilizador, total_pontos, id_area) VALUES
(4, 150, 3),
(5, 200, 4);
...
-- 6. Administradores
-- ============================================================
INSERT INTO Administradores (id_utilizador) VALUES
(1);
...
-- 11. Estados
-- ============================================================
INSERT INTO Estados (nome_estado, descricao_estado) VALUES
('submetido', 'pelo consultor -> avança para TM'),
('correto',   'resposta do TM -> avança para SLL'),
('incorreto', 'resposta do TM -> devolução para o consultor com motivo'),
('aprovado',  'resposta do SLL -> end'),
('rejeitado', 'resposta do SLL -> end'),
('devolvido', 'resposta do SLL -> devolução para o consultor com motivo');
...
-- 23. Politicas
-- ============================================================
INSERT INTO Politicas (id_administrador, politica, created_at, updated_at) VALUES
