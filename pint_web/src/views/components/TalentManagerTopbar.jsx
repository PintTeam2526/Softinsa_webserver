  ...
  return (
    <div className="softinsa-shell-notification-panel" role="dialog" aria-label="Repositorio de notificacoes">
      <div className="softinsa-shell-notification-panel-header">
        ...
        <button type="button" className="softinsa-shell-notification-panel-close" onClick={onClose} aria-label="Fechar notificacoes">
          x
        </button>
      </div>
      ...
      {isComposerOpen ? (
        <div className="softinsa-shell-notification-compose">
          <label className="softinsa-shell-notification-compose-label" htmlFor="softinsa-shell-notification-compose-message">
          ...
          <div className="softinsa-shell-notification-compose-actions">
            <button type="button" className="softinsa-shell-notification-send-btn" onClick={onSendBroadcast} disabled={isSendDisabled}>
              Enviar
            </button>
          </div>
        </div>
...
const TalentManagerTopbar = memo(() => {
  const {
    notificationWrapRef,
    isNotificationsOpen,
...
export default TalentManagerTopbar